% data_collection_24well_4rows_imaging_48-51.nc
; Generated by generate_nc_files.py
; Samples 48–51 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      48         60         13.0       33       0.4     
; B      49         120        13.0       31       0.4     
; C      50         110        6.0        32       0.8     
; D      51         150        14.0       30       0.5     
;
; REGENHU
...
; ── Row A │ Sample 48 │ P=60kPa  F=13.0mm/s  T=33°C  Z=0.400mm ──
...
; ── Row B │ Sample 49 │ P=120kPa  F=13.0mm/s  T=31°C  Z=0.400mm ──
G805[50.080, 9.655, 2.870] ; Set G55 origin
G55
G00 Z18.400
Y2.900
M110=260 ; Set printing progress to 26%
M300=310 ; Set tool temperature to 31.0°C
M302 ; Wait for tool temperature
Z0.400
M160 ; Turn on dispensing
G01 Y-2.900
...
; ── Row C │ Sample 50 │ P=110kPa  F=6.0mm/s  T=32°C  Z=0.800mm ──
...
; ── Row D │ Sample 51 │ P=150kPa  F=14.0mm/s  T=30°C  Z=0.500mm ──
