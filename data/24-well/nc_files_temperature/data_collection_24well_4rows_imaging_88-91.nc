% data_collection_24well_4rows_imaging_88-91.nc
; Generated by generate_nc_files.py
; Samples 88–91 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      88         110        10.0       37       0.4     
; B      89         90         11.0       33       0.6     
; C      90         120        10.0       36       0.6     
; D      91         70         11.0       29       0.6     
;
; REGENHU
...
; ── Row A │ Sample 88 │ P=110kPa  F=10.0mm/s  T=37°C  Z=0.400mm ──
...
F10.000
M300=370 ; Set tool temperature to 37.0°C
...
; ── Row B │ Sample 89 │ P=90kPa  F=11.0mm/s  T=33°C  Z=0.600mm ──
...
; ── Row C │ Sample 90 │ P=120kPa  F=10.0mm/s  T=36°C  Z=0.600mm ──
...
M300=360 ; Set tool temperature to 36.0°C
M302 ; Wait for tool temperature
Z0.600
M160 ; Turn on dispensing
G01 X-2.900
...
; ── Row D │ Sample 91 │ P=70kPa  F=11.0mm/s  T=29°C  Z=0.600mm ──
