% data_collection_24well_4rows_imaging_92-95.nc
; Generated by generate_nc_files.py
; Samples 92–95 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      92         140        12.0       32       0.8     
; B      93         100        7.0        34       0.7     
; C      94         70         12.0       37       0.7     
; D      95         130        8.0        37       0.6     
;
...
; ── Row A │ Sample 92 │ P=140kPa  F=12.0mm/s  T=32°C  Z=0.800mm ──
...
; ── Row B │ Sample 93 │ P=100kPa  F=7.0mm/s  T=34°C  Z=0.700mm ──
...
; ── Row C │ Sample 94 │ P=70kPa  F=12.0mm/s  T=37°C  Z=0.700mm ──
...
; ── Row D │ Sample 95 │ P=130kPa  F=8.0mm/s  T=37°C  Z=0.600mm ──
