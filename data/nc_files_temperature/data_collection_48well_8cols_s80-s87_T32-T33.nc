% data_collection_48well_8cols_s80-s87_T32-T33.nc
...
; 1     80         110        14.0       32       0.7     
; 2     81         115        10.0       32       0.4     
; 3     82         65         8.0        33       0.4     
; 4     83         65         12.0       33       0.7     
; 5     84         65         14.0       33       0.5     
; 6     85         70         7.0        33       0.9     
...
; ── Col 1 | Sample 80 | P=110kPa  F=14.0mm/s  T=32C  Z=0.700mm ──
...
F14.000
M300=320 ; Set tool temperature to 32.0C
...
; ── Col 2 | Sample 81 | P=115kPa  F=10.0mm/s  T=32C  Z=0.400mm ──
...
; ── Col 3 | Sample 82 | P=65kPa  F=8.0mm/s  T=33C  Z=0.400mm ──
...
; ── Col 4 | Sample 83 | P=65kPa  F=12.0mm/s  T=33C  Z=0.700mm ──
...
; ── Col 5 | Sample 84 | P=65kPa  F=14.0mm/s  T=33C  Z=0.500mm ──
...
; ── Col 6 | Sample 85 | P=70kPa  F=7.0mm/s  T=33C  Z=0.900mm ──
...
; ── Col 7 | Sample 86 | P=75kPa  F=15.0mm/s  T=33C  Z=0.600mm ──
...
; ── Col 8 | Sample 87 | P=90kPa  F=10.0mm/s  T=33C  Z=0.400mm ──
