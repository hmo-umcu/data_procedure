% data_collection_24well_4rows_imaging_60-63.nc
; Generated by generate_nc_files.py
; Samples 60–63 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      60         120        12.0       37       0.5     
; B      61         130        6.0        34       0.5     
; C      62         150        7.0        28       0.6     
; D      63         110        12.0       29       0.5     
;
; REGENHU
...
; ── Row A │ Sample 60 │ P=120kPa  F=12.0mm/s  T=37°C  Z=0.500mm ──
...
; ── Row B │ Sample 61 │ P=130kPa  F=6.0mm/s  T=34°C  Z=0.500mm ──
...
; ── Row C │ Sample 62 │ P=150kPa  F=7.0mm/s  T=28°C  Z=0.600mm ──
...
; ── Row D │ Sample 63 │ P=110kPa  F=12.0mm/s  T=29°C  Z=0.500mm ──
