% data_collection_24well_4rows_imaging_40-43.nc
; Generated by generate_nc_files.py
; Samples 40–43 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      40         150        15.0       33       0.9     
; B      41         90         5.0        33       0.6     
; C      42         100        13.0       30       0.6     
; D      43         70         7.0        31       0.6     
;
; REGENHU
...
; ── Row A │ Sample 40 │ P=150kPa  F=15.0mm/s  T=33°C  Z=0.900mm ──
...
; ── Row B │ Sample 41 │ P=90kPa  F=5.0mm/s  T=33°C  Z=0.600mm ──
...
; ── Row C │ Sample 42 │ P=100kPa  F=13.0mm/s  T=30°C  Z=0.600mm ──
...
; ── Row D │ Sample 43 │ P=70kPa  F=7.0mm/s  T=31°C  Z=0.600mm ──
