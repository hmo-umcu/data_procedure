% data_collection_24well_4rows_imaging_84-87.nc
; Generated by generate_nc_files.py
; Samples 84–87 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      84         80         11.0       31       0.5     
; B      85         90         15.0       34       0.8     
; C      86         150        10.0       37       0.9     
; D      87         80         13.0       31       0.8     
;
; REGENHU
...
; ── Row A │ Sample 84 │ P=80kPa  F=11.0mm/s  T=31°C  Z=0.500mm ──
...
; ── Row B │ Sample 85 │ P=90kPa  F=15.0mm/s  T=34°C  Z=0.800mm ──
...
; ── Row C │ Sample 86 │ P=150kPa  F=10.0mm/s  T=37°C  Z=0.900mm ──
...
; ── Row D │ Sample 87 │ P=80kPa  F=13.0mm/s  T=31°C  Z=0.800mm ──
