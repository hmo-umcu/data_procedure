% data_collection_24well_4rows_imaging_56-59.nc
; Generated by generate_nc_files.py
; Samples 56–59 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      56         80         11.0       30       0.6     
; B      57         140        14.0       36       0.7     
; C      58         130        14.0       30       0.7     
; D      59         90         6.0        29       0.4     
;
; REGENHU
...
; ── Row A │ Sample 56 │ P=80kPa  F=11.0mm/s  T=30°C  Z=0.600mm ──
...
; ── Row B │ Sample 57 │ P=140kPa  F=14.0mm/s  T=36°C  Z=0.700mm ──
...
; ── Row C │ Sample 58 │ P=130kPa  F=14.0mm/s  T=30°C  Z=0.700mm ──
...
; ── Row D │ Sample 59 │ P=90kPa  F=6.0mm/s  T=29°C  Z=0.400mm ──
