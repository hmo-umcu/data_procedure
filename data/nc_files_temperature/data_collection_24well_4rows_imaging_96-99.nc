% data_collection_24well_4rows_imaging_96-99.nc
; Generated by generate_nc_files.py
; Samples 96–99 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      96         130        9.0        35       0.8     
; B      97         160        9.0        28       0.5     
; C      98         80         10.0       36       0.9     
; D      99         120        14.0       38       0.6     
;
; REGENHU
...
; ── Row A │ Sample 96 │ P=130kPa  F=9.0mm/s  T=35°C  Z=0.800mm ──
...
; ── Row B │ Sample 97 │ P=160kPa  F=9.0mm/s  T=28°C  Z=0.500mm ──
...
; ── Row C │ Sample 98 │ P=80kPa  F=10.0mm/s  T=36°C  Z=0.900mm ──
...
; ── Row D │ Sample 99 │ P=120kPa  F=14.0mm/s  T=38°C  Z=0.600mm ──
