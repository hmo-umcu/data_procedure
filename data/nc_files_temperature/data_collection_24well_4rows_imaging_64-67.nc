% data_collection_24well_4rows_imaging_64-67.nc
; Generated by generate_nc_files.py
; Samples 64–67 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      64         70         13.0       30       0.7     
; B      65         80         5.0        32       0.8     
; C      66         70         14.0       36       0.5     
; D      67         120        12.0       35       0.6     
;
; REGENHU
...
; ── Row A │ Sample 64 │ P=70kPa  F=13.0mm/s  T=30°C  Z=0.700mm ──
...
; ── Row B │ Sample 65 │ P=80kPa  F=5.0mm/s  T=32°C  Z=0.800mm ──
...
; ── Row C │ Sample 66 │ P=70kPa  F=14.0mm/s  T=36°C  Z=0.500mm ──
...
; ── Row D │ Sample 67 │ P=120kPa  F=12.0mm/s  T=35°C  Z=0.600mm ──
