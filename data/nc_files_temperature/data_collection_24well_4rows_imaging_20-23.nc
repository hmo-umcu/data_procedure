% data_collection_24well_4rows_imaging_20-23.nc
; Generated by generate_nc_files.py
; Samples 20–23 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      20         130        6.0        32       0.4     
; B      21         60         8.0        37       0.4     
; C      22         150        10.0       29       0.7     
; D      23         100        10.0       29       0.5     
;
; REGENHU
...
; ── Row A │ Sample 20 │ P=130kPa  F=6.0mm/s  T=32°C  Z=0.400mm ──
...
; ── Row B │ Sample 21 │ P=60kPa  F=8.0mm/s  T=37°C  Z=0.400mm ──
...
; ── Row C │ Sample 22 │ P=150kPa  F=10.0mm/s  T=29°C  Z=0.700mm ──
...
; ── Row D │ Sample 23 │ P=100kPa  F=10.0mm/s  T=29°C  Z=0.500mm ──
