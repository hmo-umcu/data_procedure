% data_collection_24well_4rows_imaging_32-35.nc
; Generated by generate_nc_files.py
; Samples 32–35 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      32         150        10.0       35       0.4     
; B      33         140        7.0        34       0.7     
; C      34         100        9.0        38       0.6     
; D      35         70         11.0       33       0.7     
;
...
; ── Row A │ Sample 32 │ P=150kPa  F=10.0mm/s  T=35°C  Z=0.400mm ──
...
; ── Row B │ Sample 33 │ P=140kPa  F=7.0mm/s  T=34°C  Z=0.700mm ──
...
; ── Row C │ Sample 34 │ P=100kPa  F=9.0mm/s  T=38°C  Z=0.600mm ──
...
M300=380 ; Set tool temperature to 38.0°C
M302 ; Wait for tool temperature
Z0.600
M160 ; Turn on dispensing
G01 X-2.900
...
; ── Row D │ Sample 35 │ P=70kPa  F=11.0mm/s  T=33°C  Z=0.700mm ──
