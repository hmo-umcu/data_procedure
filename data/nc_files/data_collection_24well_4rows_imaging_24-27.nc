% data_collection_24well_4rows_imaging_24-27.nc
; Generated by generate_nc_files.py
; Samples 24–27 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      24         110        6.0        34       0.4     
; B      25         110        14.0       32       0.8     
; C      26         130        13.0       28       0.5     
; D      27         70         7.0        35       0.8     
;
; REGENHU
...
; ── Row A │ Sample 24 │ P=110kPa  F=6.0mm/s  T=34°C  Z=0.400mm ──
...
F6.000
M300=340 ; Set tool temperature to 34.0°C
...
; ── Row B │ Sample 25 │ P=110kPa  F=14.0mm/s  T=32°C  Z=0.800mm ──
G805[50.080, 9.655, 2.870] ; Set G55 origin
G55
G00 Z18.400
Y2.900
M110=260 ; Set printing progress to 26%
M300=320 ; Set tool temperature to 32.0°C
M302 ; Wait for tool temperature
Z0.800
M160 ; Turn on dispensing
G01 Y-2.900
...
; ── Row C │ Sample 26 │ P=130kPa  F=13.0mm/s  T=28°C  Z=0.500mm ──
...
M300=280 ; Set tool temperature to 28.0°C
M302 ; Wait for tool temperature
Z0.500
M160 ; Turn on dispensing
G01 X-2.900
...
; ── Row D │ Sample 27 │ P=70kPa  F=7.0mm/s  T=35°C  Z=0.800mm ──
