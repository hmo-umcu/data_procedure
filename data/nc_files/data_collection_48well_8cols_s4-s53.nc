...
G807[2, 0.300, 0.300]
M160                      ; H1 ON
G01 X2.800      ; H-strand 1
M161                      ; H1 OFF
G00 X2.500 Y0.000  ; → H-strand 2 start
G807[2, 0.300, 0.300]
M160                      ; H2 ON
G01 X-2.800      ; H-strand 2
M161                      ; H2 OFF
G00 X-2.500 Y2.000  ; → H-strand 3 start
G807[2, 0.300, 0.300]
M160                      ; H3 ON
G01 X2.800      ; H-strand 3
M161                      ; H3 OFF
G00 Z1.400                   ; lift 1.0mm — clear H-strands
G00 X-2.000 Y-2.500  ; → V-strand 1 start
G00 Z0.400                    ; lower to print height
G807[2, 0.300, 0.300]
M160                      ; V1 ON
G01 Y2.800      ; V-strand 1
M161                      ; V1 OFF
G00 X0.000 Y2.500  ; → V-strand 2 start
G807[2, 0.300, 0.300]
M160                      ; V2 ON
G01 Y-2.800      ; V-strand 2
M161                      ; V2 OFF
G00 X2.000 Y-2.500  ; → V-strand 3 start
G807[2, 0.300, 0.300]
M160                      ; V3 ON
G01 Y2.800      ; V-strand 3
M161                      ; V3 OFF
