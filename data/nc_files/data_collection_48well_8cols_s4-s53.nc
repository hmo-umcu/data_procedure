...
; INITIALIZATION
T1
M200=850 ; Set pressure to 85kPa
T0
...
; -- Col 1 | Sample 4 | P=85kPa  F=7.0mm/s  Z=0.400mm --
...
Z0.400
M110=40
G807[2, 0.300, 0.300]        ; start delay 0.3mm, stop delay 0.3mm
M160                      ; H1 ON
G01 X2.300      ; H-strand 1 (extended +0.3mm for start-delay comp)
M161                      ; H1 OFF
G00 X2.000 Y0.000  ; → H-strand 2 start
G807[2, 0.300, 0.300]        ; start delay 0.3mm, stop delay 0.3mm
M160                      ; H2 ON
G01 X-2.300      ; H-strand 2 (extended +0.3mm for start-delay comp)
M161                      ; H2 OFF
G00 X-2.000 Y2.500  ; → H-strand 3 start
G807[2, 0.300, 0.300]        ; start delay 0.3mm, stop delay 0.3mm
M160                      ; H3 ON
G01 X2.300      ; H-strand 3 (extended +0.3mm for start-delay comp)
M161                      ; H3 OFF
...
G807[2, 0.300, 0.300]        ; start delay 0.3mm, stop delay 0.3mm
M160                      ; V1 ON
G01 Y2.300      ; V-strand 1 (extended +0.3mm for start-delay comp)
M161                      ; V1 OFF
G00 X0.000 Y2.000  ; → V-strand 2 start
G807[2, 0.300, 0.300]        ; start delay 0.3mm, stop delay 0.3mm
M160                      ; V2 ON
G01 Y-2.300      ; V-strand 2 (extended +0.3mm for start-delay comp)
M161                      ; V2 OFF
G00 X2.500 Y-2.000  ; → V-strand 3 start
G807[2, 0.300, 0.300]        ; start delay 0.3mm, stop delay 0.3mm
M160                      ; V3 ON
G01 Y2.300      ; V-strand 3 (extended +0.3mm for start-delay comp)
M161                      ; V3 OFF
...
; -- Col 2 | Sample 11 | P=90kPa  F=7.0mm/s  Z=0.300mm --
...
; -- Col 3 | Sample 18 | P=95kPa  F=11.0mm/s  Z=0.400mm --
...
; -- Col 4 | Sample 25 | P=100kPa  F=8.0mm/s  Z=0.300mm --
...
; -- Col 5 | Sample 32 | P=105kPa  F=9.0mm/s  Z=0.500mm --
...
; -- Col 6 | Sample 39 | P=110kPa  F=8.0mm/s  Z=0.400mm --
...
; -- Col 7 | Sample 46 | P=115kPa  F=6.0mm/s  Z=0.700mm --
...
G01 X2.300      ; H-strand 3 (extended +0.3mm for start-delay comp)
M161                      ; H3 OFF
G00 Z1.700                   ; lift 1.0mm — clear H-strands
G00 X-2.500 Y-2.000  ; → V-strand 1 start
...
; -- Col 8 | Sample 53 | P=120kPa  F=13.0mm/s  Z=0.200mm --
