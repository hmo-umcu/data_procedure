% data_collection_24well_4rows_imaging_16-19.nc
; Generated by generate_nc_files.py
; Samples 16–19 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      16         150        13.0       30       0.7     
; B      17         120        9.0        34       0.8     
; C      18         130        13.0       34       0.9     
; D      19         160        14.0       34       0.8     
;
; REGENHU
...
; ── Row A │ Sample 16 │ P=150kPa  F=13.0mm/s  T=30°C  Z=0.700mm ──
...
; ── Row B │ Sample 17 │ P=120kPa  F=9.0mm/s  T=34°C  Z=0.800mm ──
...
; ── Row C │ Sample 18 │ P=130kPa  F=13.0mm/s  T=34°C  Z=0.900mm ──
...
; ── Row D │ Sample 19 │ P=160kPa  F=14.0mm/s  T=34°C  Z=0.800mm ──
