% data_collection_24well_4rows_imaging_36-39.nc
; Generated by generate_nc_files.py
; Samples 36–39 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      36         100        13.0       28       0.8     
; B      37         110        13.0       38       0.8     
; C      38         100        14.0       33       0.5     
; D      39         110        12.0       33       0.9     
;
; REGENHU
...
; ── Row A │ Sample 36 │ P=100kPa  F=13.0mm/s  T=28°C  Z=0.800mm ──
...
; ── Row B │ Sample 37 │ P=110kPa  F=13.0mm/s  T=38°C  Z=0.800mm ──
...
; ── Row C │ Sample 38 │ P=100kPa  F=14.0mm/s  T=33°C  Z=0.500mm ──
...
; ── Row D │ Sample 39 │ P=110kPa  F=12.0mm/s  T=33°C  Z=0.900mm ──
