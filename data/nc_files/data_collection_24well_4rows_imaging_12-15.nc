% data_collection_24well_4rows_imaging_12-15.nc
; Generated by generate_nc_files.py
; Samples 12–15 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      12         150        8.0        30       0.5     
; B      13         120        9.0        37       0.7     
; C      14         140        11.0       33       0.9     
; D      15         130        15.0       36       0.5     
;
; REGENHU
...
; ── Row A │ Sample 12 │ P=150kPa  F=8.0mm/s  T=30°C  Z=0.500mm ──
...
; ── Row B │ Sample 13 │ P=120kPa  F=9.0mm/s  T=37°C  Z=0.700mm ──
...
; ── Row C │ Sample 14 │ P=140kPa  F=11.0mm/s  T=33°C  Z=0.900mm ──
...
; ── Row D │ Sample 15 │ P=130kPa  F=15.0mm/s  T=36°C  Z=0.500mm ──
