% data_collection_24well_4rows_imaging_28-31.nc
; Generated by generate_nc_files.py
; Samples 28–31 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      28         90         7.0        37       0.7     
; B      29         110        6.0        29       0.9     
; C      30         60         10.0       33       0.6     
; D      31         150        14.0       32       0.7     
;
; REGENHU
...
; ── Row A │ Sample 28 │ P=90kPa  F=7.0mm/s  T=37°C  Z=0.700mm ──
...
; ── Row B │ Sample 29 │ P=110kPa  F=6.0mm/s  T=29°C  Z=0.900mm ──
...
; ── Row C │ Sample 30 │ P=60kPa  F=10.0mm/s  T=33°C  Z=0.600mm ──
...
; ── Row D │ Sample 31 │ P=150kPa  F=14.0mm/s  T=32°C  Z=0.700mm ──
