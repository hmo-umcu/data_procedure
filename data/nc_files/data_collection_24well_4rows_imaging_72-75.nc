...
; Samples 72-75 from CSV
;
; Row    SampleID   P(kPa)     F(mm/s)    Z(mm)   
; A      72         160        12.0       0.4     
; B      73         70         7.0        0.7     
; C      74         130        8.0        0.8     
; D      75         100        8.0        0.8     
;
; !! Set temperature manually in Architect UI before clicking Start !!
;
; REGENHU
...
; INITIALIZATION
T1
M200=1600 ; Set pressure to 160.0kPa
T0
...
; -- Row A | Sample 72 | P=160kPa  F=12.0mm/s  Z=0.400mm --
...
; -- Row B | Sample 73 | P=70kPa  F=7.0mm/s  Z=0.700mm --
...
; -- Row C | Sample 74 | P=130kPa  F=8.0mm/s  Z=0.800mm --
...
; -- Row D | Sample 75 | P=100kPa  F=8.0mm/s  Z=0.800mm --
