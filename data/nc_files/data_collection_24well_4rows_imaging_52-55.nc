% data_collection_24well_4rows_imaging_52-55.nc
; Generated by generate_nc_files.py
; Samples 52–55 from C:\Users\hmo\hmo_workspace\data_procedure\data\lhs\lhs_bioprint_samples_semicolon.csv
;
; Row    SampleID   P(kPa)     F(mm/s)    T(°C)    Z(mm)   
; A      52         110        15.0       34       0.5     
; B      53         100        10.0       38       0.7     
; C      54         60         8.0        34       0.8     
; D      55         140        9.0        32       0.8     
;
; REGENHU
...
; ── Row A │ Sample 52 │ P=110kPa  F=15.0mm/s  T=34°C  Z=0.500mm ──
...
; ── Row B │ Sample 53 │ P=100kPa  F=10.0mm/s  T=38°C  Z=0.700mm ──
...
; ── Row C │ Sample 54 │ P=60kPa  F=8.0mm/s  T=34°C  Z=0.800mm ──
...
; ── Row D │ Sample 55 │ P=140kPa  F=9.0mm/s  T=32°C  Z=0.800mm ──
