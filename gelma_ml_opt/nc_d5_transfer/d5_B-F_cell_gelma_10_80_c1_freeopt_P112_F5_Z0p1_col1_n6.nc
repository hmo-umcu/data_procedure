% d5_B-F_cell_gelma_10_80_c1_freeopt_P112_F5_Z0p1_col1_n6
...
;
; Pressure     : 112 kPa  -> M200=1120
; Nozzle speed : 5 mm/s -> F
; Z offset     : 0.1 mm
; Wells        : column 1, A1-F1 (6 replicates)
;
; Predicted SF on the cell-laden surface : 0.6641 +/- 0.0869
; Transfer regret for this pair          : 0.0202 SF (0.96x noise floor 0.021)
; D5 verdict                             : cell-free calibration transfers: the loss is within measurement noise
;
...
; -- well A1 | replicate 1/6 | P=112 kPa  F=5 mm/s  Z=0.100 mm --
...
; -- well B1 | replicate 2/6 | P=112 kPa  F=5 mm/s  Z=0.100 mm --
...
; -- well C1 | replicate 3/6 | P=112 kPa  F=5 mm/s  Z=0.100 mm --
...
; -- well D1 | replicate 4/6 | P=112 kPa  F=5 mm/s  Z=0.100 mm --
...
; -- well E1 | replicate 5/6 | P=112 kPa  F=5 mm/s  Z=0.100 mm --
...
; -- well F1 | replicate 6/6 | P=112 kPa  F=5 mm/s  Z=0.100 mm --
...
; 6 replicates of P=112 kPa F=5 mm/s Z=0.1 mm in cell_gelma_10_80
;
#FLUSH WAIT
