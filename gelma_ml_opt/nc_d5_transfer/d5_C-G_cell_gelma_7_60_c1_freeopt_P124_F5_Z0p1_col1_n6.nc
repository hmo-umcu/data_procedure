% d5_C-G_cell_gelma_7_60_c1_freeopt_P124_F5_Z0p1_col1_n6
...
;
; =============== WHAT TO LOAD ===============
; INK IN THE CARTRIDGE : cell_gelma_7_60    <-- CELL-LADEN
; Both conditions of this pair use this same cell-laden ink.
; Nothing in this experiment is printed cell-free.
; ============================================
;
; Pair         : C/G  (gelma_7_60 -> cell_gelma_7_60)
; Condition    : 1 of 2   [freeopt]
; Meaning      : optimum derived from the CELL-FREE dataset, printed in cell-laden ink
; Derived from : gelma_7_60 48-well data
;
; Pressure     : 124 kPa  -> M200=1240
; Nozzle speed : 5 mm/s -> F
; Z offset     : 0.1 mm
; Wells        : column 1, A1-F1 (6 replicates)
;
; Predicted SF on the cell-laden surface : 0.5368 +/- 0.0691
; Transfer regret for this pair          : 0.2207 SF (11.68x noise floor 0.0189)
...
; -- well A1 | replicate 1/6 | P=124 kPa  F=5 mm/s  Z=0.100 mm --
...
; -- well B1 | replicate 2/6 | P=124 kPa  F=5 mm/s  Z=0.100 mm --
...
; -- well C1 | replicate 3/6 | P=124 kPa  F=5 mm/s  Z=0.100 mm --
...
; -- well D1 | replicate 4/6 | P=124 kPa  F=5 mm/s  Z=0.100 mm --
...
; -- well E1 | replicate 5/6 | P=124 kPa  F=5 mm/s  Z=0.100 mm --
...
; -- well F1 | replicate 6/6 | P=124 kPa  F=5 mm/s  Z=0.100 mm --
...
; 6 replicates of P=124 kPa F=5 mm/s Z=0.1 mm in cell_gelma_7_60
;
#FLUSH WAIT
