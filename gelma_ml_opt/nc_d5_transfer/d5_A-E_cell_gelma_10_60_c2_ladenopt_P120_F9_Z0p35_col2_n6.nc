% d5_A-E_cell_gelma_10_60_c2_ladenopt_P120_F9_Z0p35_col2_n6
...
; Derived from : cell_gelma_10_60 48-well data
;
; Pressure     : 120 kPa  -> M200=1200
; Nozzle speed : 9 mm/s -> F
; Z offset     : 0.35 mm
; Wells        : column 2, A2-F2 (6 replicates)
;
; Predicted SF on the cell-laden surface : 0.6916
...
; -- well A2 | replicate 1/6 | P=120 kPa  F=9 mm/s  Z=0.350 mm --
...
G00 Z1.350                   ; lift 1.0mm — clear H-strands
G00 X-2.500 Y-2.000  ; → V-strand 1 start
G00 Z0.350                    ; lower to print height
G807[2, 0.300, 0.300]
M160                      ; V1 ON
...
; -- well B2 | replicate 2/6 | P=120 kPa  F=9 mm/s  Z=0.350 mm --
...
; -- well C2 | replicate 3/6 | P=120 kPa  F=9 mm/s  Z=0.350 mm --
...
; -- well D2 | replicate 4/6 | P=120 kPa  F=9 mm/s  Z=0.350 mm --
...
; -- well E2 | replicate 5/6 | P=120 kPa  F=9 mm/s  Z=0.350 mm --
...
; -- well F2 | replicate 6/6 | P=120 kPa  F=9 mm/s  Z=0.350 mm --
...
; 6 replicates of P=120 kPa F=9 mm/s Z=0.35 mm in cell_gelma_10_60
;
#FLUSH WAIT
