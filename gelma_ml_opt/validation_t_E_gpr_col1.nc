...
;
; Col 1  A1-F1   P=82 kPa  F=15 mm/s  Z=0.1 mm   V1 ML recommendation (cell_gelma_10_60)
;
; Model: M_full:GPR
; Predicted SF_mean: 0.323831 +/- 0.117368 (GPR posterior sd)
; Trained on: cell_gelma_10_80,cell_gelma_7_60,cell_gelma_7_80,gelma_10_60,gelma_10_80
; Target SF values were NOT used to choose this condition.
;
; INITIALIZATION
T1
M200=820 ; Set pressure to 82kPa
T0
...
; -- V1 ML recommendation (cell_gelma_10_60): P=82 kPa  F=15 mm/s  Z=0.100 mm --
