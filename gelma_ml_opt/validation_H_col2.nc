...
;
; Col 2  A2-F2   P=130 kPa  F=5 mm/s  Z=0.35 mm   V1 ML recommendation (cell_gelma_7_80)
;
; Model: M_full:GPR
...
; -- V1 ML recommendation (cell_gelma_7_80): col 2  P=130 kPa  F=5 mm/s  Z=0.350 mm --
