...
;
; Col 1  A1-F1   P=107 kPa  F=5 mm/s  Z=0.1 mm   V1 ML recommendation (cell_gelma_10_80)
;
; Model: M_full:GPR
; Predicted SF_mean: 0.423473 +/- 0.110618 (GPR posterior sd)
...
; INITIALIZATION
T1
M200=1070 ; Set pressure to 107kPa
T0
...
; -- V1 ML recommendation (cell_gelma_10_80): P=107 kPa  F=5 mm/s  Z=0.100 mm --
