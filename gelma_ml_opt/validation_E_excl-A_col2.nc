...
;
; Col 2  A2-F2   P=92 kPa  F=5 mm/s  Z=0.1 mm   V1 ML recommendation (cell_gelma_10_60)
;
; Model: M_full:GPR
...
; -- V1 ML recommendation (cell_gelma_10_60): col 2  P=92 kPa  F=5 mm/s  Z=0.100 mm --
