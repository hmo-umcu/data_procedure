...
;
; Col 3  A3-F3   P=103 kPa  F=5 mm/s  Z=0.1 mm   V1 ML recommendation (cell_gelma_10_80)
;
; Model: M_full:GPR
...
; -- V1 ML recommendation (cell_gelma_10_80): col 3  P=103 kPa  F=5 mm/s  Z=0.100 mm --
