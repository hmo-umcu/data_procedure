...
;
; Col 1  A1-F1   P=130 kPa  F=5 mm/s  Z=0.1 mm   V1 ML recommendation (cell_gelma_10_60)
;
; Model: M_full:Ridge
; Predicted SF_mean: 0.4455 +/- nan (unavailable (no --comparison_csv))
; Trained on: cell_gelma_10_80,cell_gelma_7_60,cell_gelma_7_80,gelma_10_80
...
; -- V1 ML recommendation (cell_gelma_10_60): P=130 kPa  F=5 mm/s  Z=0.100 mm --
