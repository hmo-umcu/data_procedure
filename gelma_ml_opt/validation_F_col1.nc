% validation_F_col1.nc
; Generated by s08_make_validation_nc.py
; Template: data_collection_48well_8cols_s0-s28.nc  (all geometry copied verbatim)
; Recommendation: recommendation_F.csv
;
; Col 1  A1-F1   P=106 kPa  F=5 mm/s  Z=0.1 mm   V1 ML recommendation (cell_gelma_10_80)
;
; Model: M_full:GPR
; Predicted SF_mean: 0.586905 +/- 0.095719 (GPR posterior sd)
; Trained on: cell_gelma_10_60,cell_gelma_7_60,cell_gelma_7_80,gelma_10_60,gelma_10_80,gelma_7_60,gelma_7_80
; Target SF values were NOT used to choose this condition.
;
; INITIALIZATION
T1
M200=1060 ; pressure 106kPa
T0
...
; -- V1 ML recommendation (cell_gelma_10_80): col 1  P=106 kPa  F=5 mm/s  Z=0.100 mm --
