...
def save_training_outputs(model_dir, train_losses, test_losses,
                          ...
                          min_size, use_gpu, data_dir, stems):
    """
...
def train(data_dir, model_dir, n_epochs, learning_rate, weight_decay,
    ...
    # train_seg returns (model_path, train_losses, test_losses) in current cellpose
    # older versions return only model_path — handle both safely
