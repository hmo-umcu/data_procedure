...
;
; Col 1  A1-F1   P=86 kPa  F=15 mm/s  Z=0.1 mm   V1 ML recommendation (cell_gelma_10_60)
;
; Model: M_full:GPR
; Predicted SF_mean: 0.45383 +/- 0.17713 (GPR posterior sd)
...
; INITIALIZATION
T1
M200=860 ; Set pressure to 86kPa
T0
...
; -- V1 ML recommendation (cell_gelma_10_60): P=86 kPa  F=15 mm/s  Z=0.100 mm --
