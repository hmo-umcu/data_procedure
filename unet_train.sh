...
#SBATCH --output=/home/hmo/BioRT/Rheology-informed-optimization/data_procedure/logs/unet_train_%j.out
#SBATCH --error=/home/hmo/BioRT/Rheology-informed-optimization/data_procedure/logs/unet_train_%j.err
...
MODEL_DIR="$SCRIPT_DIR/models/unet/run_01"
