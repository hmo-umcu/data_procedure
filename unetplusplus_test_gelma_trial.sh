...
## cell-free trained unetpp path: models/unetplusplus/gelma_finetune_cell-free-trained/best_model.pth


## cell-laden annoated images path:data/dev_images/gelma_annot_cell-laden
## cell-laden trained unetpp path: models/unetplusplus/gelma_finetune_cell-laden-trained/best_model.pth



# ── adjust these paths ────────────────────────────────────────────────────────
MODEL_PATH="$SCRIPT_DIR/models/unetplusplus/gelma_finetune_cell-laden-trained/best_model.pth"
DATA_DIR="$SCRIPT_DIR/data/dev_images/gelma_annot_cell-free"
OUTPUT_DIR="$SCRIPT_DIR/data/dev_images/gelma_laden-trained_free-test"
